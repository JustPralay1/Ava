...
function speakThis(message) {
    ...
    if(message.includes('hey') || message.includes('hello')) {
        ...
        const finalText = "My name is Ava";
        speech.text = finalText;
    }
    ...
    else if(message.includes('Omegle')){
        window.open("https://omegle.com","_blank")
        const finalText = "Opening Omegle";
        speech.text = finalText;
    }
    ...
    else if(message.includes('translater')) {
    ...
    else if(message.includes('mcb')){
        window.open('hhtps://meridian.myclasboard.com',"_blank");
        const finalText = "Opening MCB Of Meridian School";
        speech.text = finalText
    }

    else if(message.includes('hindimeaning')){
        window.open('https://hindimeaning.com',"_blank")
        const finalText = "Opening Hindi Meaning";
        speech.text = finalText
    }
    ...
    else if(message.includes('uncademy')){
